...
<body>
    ...
    <nav class="lol">
        ...
        <a href="waterform1.php"><div class="bakwaas" style="font-family: myfont3;">Water Purifier Repair</div></a>
<a href="logout.php" style="font-size: 24px; margin: 5px; float: right; text-decoration: none; color: white; border: 1px solid; border-radius: 5px; background: #E2472F; width: 100px; text-align:center; height: 33px;">Logout</a>
	...
	<ul>
		<li>
			<label style="font-family: myfont4;">Repair/Servicing
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Installation/Uninstallation
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
