...
<head>
	<title>check</title>
	<link rel="stylesheet" type="text/css" href="washFold.css">
...
<body>
    ...
    <nav class="lol">
        ...
        <a href="kids1.php"><div class="bakwaas" style="font-family: myfont3;">Kids</div></a>
    ...
    <p style="text-align: center; font-family: myfont4; color: white; font-size: 25px; margin: 20px;">We excel in taking away the pain of finding the right clothing expert to cater to your needs, right at the comfort of your home. With reasonable pricing you can avail our clothing services with just a few clicks of a button.</p>
    <nav class="lolol">
	<form action="index.html">
	<ul>
		<li>
			<label style="font-family: myfont4;">Frock
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Shirt
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Pant
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Skirt
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
