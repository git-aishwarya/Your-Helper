...
<body>
    ...
    <nav class="lol">
        ...
        <a href="corporate1.php"><div class="bakwaas" style="font-family: myfont3;">Corporate</div></a>
	...
	<ul>
		<li>
			<label style="font-family: myfont4;">Blazer
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Coat
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Trousers
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
