...
<body>
    ...
    <nav class="lol">
        ...
        <a href="women1.php"><div class="bakwaas" style="font-family: myfont3;">Women</div></a>
	...
	<ul>
		<li>
			<label style="font-family: myfont4;">Kurta
		...
		<li>
			<label style="font-family: myfont4;">Salwaar
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Blouse
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Fall
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Pico
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
