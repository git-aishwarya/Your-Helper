...
<body>
    ...
    <nav class="lol">
        ...
        <a href="ACform1.php"><div class="bakwaas" style="font-family: myfont3;">Air Conditioner Repair</div></a>
	...
	<ul>
		<li>
			<label style="font-family: myfont4;">Wet Servicing
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Installation
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Uninstallation
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">Gas Charging
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
		<li>
			<label style="font-family: myfont4;">AC not cooling
				<input type="checkbox" name="">
				<span class= "check"></span>
			</label>
		</li>
